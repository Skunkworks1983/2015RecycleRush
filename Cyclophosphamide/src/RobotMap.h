...
#define TOTE_INTAKE_MOTOR_FULL .420
#define TOTE_INTAKE_PID_FULL 1.0
#define TOTE_INTAKE_ENCODER_TICKS_PER_REV 1024.0
...
#define TOTE_LIFTER_PID_I 0.0001
...
#define AUTO_TURN_GYRO_THRESHOLD (2)

//AutoCanGrabber
#define AUTO_CAN_GRABBER_SOLENOID_PORT_A 7
#define AUTO_CAN_GRABBER_SOLENOID_PORT_B 0
