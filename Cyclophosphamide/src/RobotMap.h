...
#define TOTE_INTAKE_MOTOR_LEFT_PORT 10
#define TOTE_INTAKE_MOTOR_RIGHT_PORT DOESNT_EXIST
...
#define INTAKE_MATCH_DRIVE_CONSTANT .5	//TODO: change dis
...
#define CAN_INDUCT_UP_TIMEOUT 0.5
