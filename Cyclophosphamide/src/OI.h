...
public:
	...
	JoystickButton *joystickScore;
	JoystickButton *joystickArmsToggle;
	JoystickButton *joystickCanToClaw;
	JoystickButton *joystickToteUp;
	JoystickButton *joystickToteDown;
	JoystickButton *joystickWristCollect;
